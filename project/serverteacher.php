...
$db = mysqli_connect('localhost', 'root', '', 'projectstudent');
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    //verify
    $query = "SELECT * FROM verify WHERE Tid='$Teacherid' AND Tname='$Tname'";
  	$results1 = mysqli_query($db, $query);
  	if (mysqli_num_rows($results1) == 1) {
    //verify ends
  	$query = "INSERT INTO teacher (username, email, password) 
    ...
    array_push($errors, "TeacherId not registered");
  }
}
}
