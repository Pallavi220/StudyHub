...
<div class="content">
    ...
    <?php  if (isset($_SESSION['username'])) : ?>
      ...
      <a href="http://localhost:3000/actionstudent.html">
    <button name="class" type="submit" value="submit" style="font-size:15px;"class="btn">
        Class
    </button>

      
		<a href="http://localhost/StudyHub/File%20Upload%20in%20JavaScript/" style="color: red;">
    <button name="upload" type="submit" value="submit" style="font-size:15px;"class="btn">
        Upload
    </button>

    <a href="http://localhost/StudyHub/File%20Upload%20in%20JavaScript/php/" style="color: red;">
    <button name="download" type="submit" value="submit" style="font-size:15px;"class="btn">
        Download
    </button>

      <a href="http://localhost/StudyHub/project/login.php">
